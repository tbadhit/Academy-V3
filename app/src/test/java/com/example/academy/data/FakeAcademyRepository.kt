...
class FakeAcademyRepository constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): FakeAcademyRepository =
            instance ?: synchronized(this) {
                instance ?: FakeAcademyRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
